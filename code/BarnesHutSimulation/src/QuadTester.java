...
public class QuadTester {
    ...
    public static void main(String[] args) {
        ...
        if (nw.contains(0.0, 0.0))
        	System.out.println("(0, 0) found in NW quadrant");
        if (ne.contains(0.0, 0.0))
        	System.out.println("(0, 0) found in NE quadrant");
        if (sw.contains(0.0, 0.0))
        	System.out.println("(0, 0) found in SW quadrant");
        if (se.contains(0.0, 0.0))
        	System.out.println("(0, 0) found in SE quadrant");
        
        if (sw.NW().contains(0.0, 0.0))
        	System.out.println("(0, 0) found in NW quadrant");
        if (sw.NE().contains(0.0, 0.0))
        	System.out.println("(0, 0) found in NE quadrant");
        if (sw.SW().contains(0.0, 0.0))
        	System.out.println("(0, 0) found in SW quadrant");
        if (sw.SE().contains(0.0, 0.0))
        	System.out.println("(0, 0) found in SE quadrant");
        
//        if (se.NW().contains(0.0, 0.0))
//        	System.out.println("(0, 0) found in NW quadrant");
//        if (se.NE().contains(0.0, 0.0))
//        	System.out.println("(0, 0) found in NE quadrant");
//        if (se.SW().contains(0.0, 0.0))
//        	System.out.println("(0, 0) found in SW quadrant");
//        if (se.SE().contains(0.0, 0.0))
//        	System.out.println("(0, 0) found in SE quadrant");
