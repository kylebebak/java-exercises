...
public class MapsPQ<Key extends Comparable<Key>> implements
	...
	/**
	 * Reset PQ. If the queue is not full, this runs faster than instantiating a
	 * new PQ
	 */
	public void reset() {
		int v;
		...
		// v = pq[i];
		// if (v != 0 || qp[v] != -1 || keys[v] != null)
		// StdOut.println("reset unsuccesful");
		// }
	}
	...
	public static void main(String[] args) {
		...
		MapsPQ<String> pq = new MapsPQ<String>(strings.length);
